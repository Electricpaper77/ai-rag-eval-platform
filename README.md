...
Production-style FastAPI backend for evaluating AI-agent responses before deployment. It keeps the existing OpenAI-compatible inference gateway while adding deterministic evaluation, guardrail scoring, JSONL audit logs, and Prometheus metrics for hallucination risk, citation coverage, PII leakage, prompt-injection compliance, and refusal accuracy.
